...
с native-image. В нативном бинаре **74 тула**; для публикации AsciiDoc используйте JVM-режим или плагин.
...
`jcodings` иначе форсит build-time-инициализацию). В JVM-режиме CLI он остаётся — там доступны все 75 тулов.
