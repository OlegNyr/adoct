...
с native-image. В нативном бинаре **61 тул**; для публикации AsciiDoc используйте JVM-режим или плагин.
...
`jcodings` иначе форсит build-time-инициализацию). В JVM-режиме CLI он остаётся — там доступны все 62 тула.
