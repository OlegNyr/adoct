...
public class AdoctMcpServerTest {
    ...
    public void setUp() throws IOException {
        ...
        EndpointSupplier supplier = new EndpointSupplier() {
            ...
            @Override
            public List<io.github.adoct.mcp.TeamMember> team() {
                return List.of(new io.github.adoct.mcp.TeamMember("jdoe", "John Doe", "Backend"));
            }

            @Override
            public List<io.github.adoct.mcp.Template> templates() {
                return List.of(new io.github.adoct.mcp.Template("story", "As a … I want … so that …"));
            }
        };
