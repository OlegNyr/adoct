...
/** {@code jira_get_issue_watchers} — наблюдатели задачи Jira. */
public final class JiraGetWatchers implements Tool {
    ...
    public McpTool create(ToolContext c) {
        ...
        return new McpTool("jira_get_issue_watchers", "Наблюдатели задачи Jira.", schema, args ->
                c.ok(c.jira(args).getWatchers(c.reqStr(args, "issueKey"))));
    }
}
