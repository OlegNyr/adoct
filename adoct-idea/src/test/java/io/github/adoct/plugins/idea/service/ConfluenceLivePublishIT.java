package io.github.adoct.plugins.idea.service;

import org.junit.Test;
import io.github.adoct.generate.confluence.ConfluenceClient;
import io.github.adoct.generate.confluence.PageVersion;
...
public class ConfluenceLivePublishIT {
    ...
    public void resolvesDisplayUrlAndPublishes() throws Exception {
        ...
        Optional<String> pageId = io.github.adoct.generate.AdocPublisher.resolvePageId(client, url);
    ...
    public void exportResolvesDisplayUrl() {
        ...
        io.github.adoct.parser.confluence.ConfluenceClient client =
                new io.github.adoct.parser.confluence.ConfluenceClient(base, token);
     ...
     * и весь {@link io.github.adoct.parser.DispatcherPage}.
     */
    @Test
    public void exportPageToFolder() throws Exception {
        ...
        io.github.adoct.parser.DispatcherPage dispatcher = new io.github.adoct.parser.DispatcherPage(
                client, target, io.github.adoct.parser.confluence.ObjectMapperExt.INSTANT);
